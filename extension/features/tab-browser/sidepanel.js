...
function render() {
  ...
  // This reduces reflows and layout thrashing, significantly improving
  // render performance when processing long tab lists.
...
function renderDomainGroup(group, windowId, container = tabListEl) {
